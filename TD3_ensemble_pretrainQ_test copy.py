...
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/Pretrain/EnsSize_{ensemble_size}_pretrainQ_loss", agent.critic_loss_history)

torch.save(agent.critic.state_dict(),
                                   f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/SaveModels/{env_name}/TD3_pretrain_critic")
torch.save(agent.critic_target.state_dict(),
                                   f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/SaveModels/{env_name}/TD3_pretrain_critictarget")
