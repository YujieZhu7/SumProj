...
class Agent(object):
    ...
    def pretrain(self, demos, normalizers=(0, 1, 0, 1), iterations=2):
        for it in range(iterations):
            ...
            critic_loss = (F.mse_loss(demos_current_q, demos_target_q))
            ...
            if self.total_it % self.policy_freq == 0:
                ...
                Q = self.critic(demos_input, demos_policy_actions)[0] # select one critic network randomly to evaluate the policy action
