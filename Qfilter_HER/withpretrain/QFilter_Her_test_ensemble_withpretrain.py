...
num_accept_demos = 0
num_tot_demos = 0
while pretrain_steps < steps < max_steps + 1:
    # Training #
    done = False
    obs_ep = []
...
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/Pretrain/Noise{var}/{method}/EnsSize_{ensemble_size}_S{seed}_demoaccept",
        percent_accept_demos)
